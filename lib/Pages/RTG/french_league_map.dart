...
class FrenchLeagueMapScreen extends StatefulWidget {
  const FrenchLeagueMapScreen({super.key});

  @override
  State<FrenchLeagueMapScreen> createState() => _FrenchLeagueMapScreenState();
}

class _FrenchLeagueMapScreenState extends State<FrenchLeagueMapScreen> {
  ...
  Future<void> _loadProgress() async {
    final levels = await _progressService.getUnlockedLevels('french');
    setState(() {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              "assets/images/maps/french_map.jpg",
              fit: BoxFit.cover,
            ),
          ),
          // Gradient overlay
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: isUnlocked
                ? [
                    const Color.fromARGB(120, 0, 0, 255), // Blue
