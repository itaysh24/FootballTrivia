...
class ItalianLeagueMapScreen extends StatefulWidget {
  const ItalianLeagueMapScreen({super.key});

  @override
  State<ItalianLeagueMapScreen> createState() => _ItalianLeagueMapScreenState();
}

class _ItalianLeagueMapScreenState extends State<ItalianLeagueMapScreen> {
  ...
  Future<void> _loadProgress() async {
    final levels = await _progressService.getUnlockedLevels('italian');
    setState(() {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              "assets/images/maps/italian_map.jpg",
              fit: BoxFit.cover,
            ),
          ),
          // Gradient overlay
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: isUnlocked
                ? [
                    const Color.fromARGB(120, 0, 255, 0), // Green
