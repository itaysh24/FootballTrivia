...
class EnglishLeagueMapScreen extends StatefulWidget {
  const EnglishLeagueMapScreen({super.key});

  @override
  State<EnglishLeagueMapScreen> createState() => _EnglishLeagueMapScreenState();
}

class _EnglishLeagueMapScreenState extends State<EnglishLeagueMapScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              "assets/images/maps/english_map.jpg",
              fit: BoxFit.cover,
            ),
          ),
          // Gradient overlay
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: isUnlocked
                ? [
                    const Color.fromARGB(120, 255, 167, 38), // Orange
                    const Color.fromARGB(100, 255, 167, 38),
                  ]
                : [
  ...
  void _showLevelDialog(BuildContext context, int levelNumber) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color.fromARGB(139, 255, 168, 38).withOpacity(0.9),
